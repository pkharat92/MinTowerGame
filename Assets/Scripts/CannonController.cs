...
public class CannonController : MonoBehaviour
{
    ...
    public Button upAngle;
    public Button downAngle;
    public Button upPower;
    public Button downPower;
    public Button fireButton;

    [Range (0.001f, 2.0f)]
    public float TranslationIncrement = .35f;
    ...
    {
        if (_angle - AngleIncrement <= -5f) return;
        _angle -= AngleIncrement;
        _angleText.text = _angle + "";
        transform.rotation = Quaternion.Euler(0, 0, _angle);
    }
    ...
    void Start()
    {
        ...
        upAngle.onClick.AddListener(AngleUp);
        downAngle.onClick.AddListener(AngleDown);
        upPower.onClick.AddListener(PowerUp);
        downPower.onClick.AddListener(PowerDown);
        fireButton.onClick.AddListener(ShootCannonBall);
    }
